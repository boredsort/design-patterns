...
class ConcreteSubject(Subject):
    """The Subject owns some important state and notifies obervers when the state changes.
    """
    ...
    """LIst of subscribers, In real life, the list of subscribers can be store more comprehensively
...
"""Concreate Observers react to the updates issued by the Subject they had been attached
to.
"""
